...
router.get('/travel-concierge', function(req, res, next) {
  ...
  res.locals.title = 'IBM Travel Concierge - Raphael Arar';
  res.render('project');
});
...
router.get('/bot2bot', function(req, res, next) {
  ...
  res.locals.deets = "<h2>Medium</h2><ul><li>net art</li></ul><h2>Year</h2><ul><li>2017–2019</li></ul>";
  ...
  res.locals.title = 'bot2bot - Raphael Arar';
  res.render('art');
});
