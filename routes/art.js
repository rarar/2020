...
router.get('/metal-hearts', function(req, res, next) {
  ...
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>aluminum, plastic (3D print), electronics</li></ul><h2>🕒 Year</h2><ul><li>2013</li></ul><h2>🏛 Venues</h2><ul><li>Machine Project - Los Angeles, California</li><li>Calarts - Valencia, California</li></ul>";
...
router.get('/forbidden-pixel', function(req, res, next) {
  ...
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>digital video</li></ul><h2>🕒 Year</h2><ul><li>2015</li></ul><h2>🏛 Venues</h2><ul><li>El Camino College Planetarium - Torrance, California</li></ul>";
...
router.get('/projected-shadows', function(req, res, next) {
  ...
  res.locals.largethumb = "/images/forbidden-pixel-thumb.jpg";
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>digital video</li></ul><h2>🕒 Year</h2><ul><li>2014</li></ul><h2>🏛 Venues</h2><ul><li>Gamble House Museum - Pasadena, California</li></ul>";
...
router.get('/desktop-computing', function(req, res, next) {
  ...
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>polyphonic light-sensitive oscillators, modified wild kingdom oscillator, field recording, mixer</li></ul><h2>🕒 Year</h2><ul><li>2013</li></ul><h2>🏛 Venues</h2><ul><li>the wulf. - Los Angeles, California</li></ul>";
...
router.get('/chance-meeting', function(req, res, next) {
  ...
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>polyphonic light-sensitive oscillators, assorted microphones, electronics, audio processing</li></ul><h2>🕒 Year</h2><ul><li>2013</li></ul><h2>🏛 Venues</h2><ul><li>Machine Project - Los Angeles, California</li></ul>";
