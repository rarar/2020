...
router.get('/fail-engine', function(req, res, next) {
  ...
  res.locals.videothumb = '';
  res.locals.deets = "<h2>⚒️️ Medium</h2><ul><li>net art</li></ul><h2>🕒 Year</h2><ul><li>2019—Present</li></ul><h2>🏛 Venues</h2><ul><li>Aurum Ideas Factory - Pescara, Italy</li></ul>";
