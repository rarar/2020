...
router.get('/nostalgia', function(req, res, next) {
  ...
  res.locals.deets = "<h2>Medium ⚒️️</h2><ul><li>acrylic, steel, modified electronics, various plastic components</li></ul><h2>Year 🕒</h2><ul><li>2017–Present</li></ul><h2>Venues 🏛</h2><ul><li>SLAC National Accelerator Laboratory - Menlo Park, California</li></ul>";
  ...
  res.locals.title = 'Nostaliga - Raphael Arar';
  res.render('art');
});
...
router.get('/fail-engine', function(req, res, next) {
  ...
  res.locals.deets = "<h2>Medium ⚒️️</h2><ul><li>net art</li></ul><h2>Year 🕒</h2><ul><li>2019—Present</li></ul><h2>Venues 🏛</h2><ul><li>Aurum Ideas Factory - Pescara, Italy</li></ul>";
